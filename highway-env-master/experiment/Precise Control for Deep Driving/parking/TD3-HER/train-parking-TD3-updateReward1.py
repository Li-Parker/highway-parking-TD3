...
parser.add_argument('--ckpt_dir', type=str, default='./checkpoints_updateForward1/TD3/')
...
def main():
    ...
    viz = Visdom()
    viz.line([[-50, -50]], [0.], win='TD3-parking_v0_1', opts=dict(title='TD3-parking_v0_1'))
    """
    ...
    for episode in range(args.max_episodes):
        ...
        while (not done) and (not done_):
            ...
            if is_success:
                reward = reward + 10
            if is_crashed or done or done_:
        ...
        viz.line([[total_reward, avg_reward]], [episode + 1], win='TD3-parking_v0_1', update='append')
