...
parser.add_argument('--ckpt_dir', type=str, default='./checkpoints_updateInitialPosition_cr70_d100/TD3/')
parser.add_argument('--figure_file', type=str, default='./output_images/reward_updateInitialPosition_cr70_d100.png')
...
def main():
    ...
    # "collision_reward"
    env.config["collision_reward"] = -70
    # env.config["manual_control"] = True

    print(env.config)
    viz = Visdom()
    viz.line([[-50, -50]], [0.], win='TD3_updateInitialPosition-parking_v0_cr70_d100',
             opts=dict(title='TD3_updateInitialPosition-parking_v0_cr70_d100'))
    """
    ...
    for episode in range(args.max_episodes):
        ...
        viz.line([[total_reward, avg_reward]], [episode + 1], win='TD3_updateInitialPosition-parking_v0_cr70_d100',
                 update='append')
